...
static NSString* TAG = @"SOCIAL SocialUtils";
...
+ (NSString*)deviceIdPreferVendor {
    if ([[UIDevice currentDevice] respondsToSelector:@selector(identifierForVendor)]) {
        ...
        return @"SOCIAL_ID_1234567890";
    }
}

/* We check for UDID_SOCIAL to support devices with older versions of ios-store */
+ (NSString*)deviceId {
    NSString* udid = [[NSUserDefaults standardUserDefaults] stringForKey:@"UDID_SOCIAL"];
